...
impl Confusion {
    ...
    pub fn calculate_auc_pr(&self, min_recall: f64) -> f64 {
        ...
        // TODO(hayesall): This drops the size() == 0 error, a guard against empty vectors should probably be added elsewhere.
        ...
        // In the Java version this is initialized as null, but Rust doesn't have nulls.
        // This should be a point of debugging if results look weird.
    ...
    pub fn calculate_aucroc(&self) -> f64 {
        // TODO(hayesall): Again, I removed the size() == 0 guard, and it should probably be guarded against elsewhere.
